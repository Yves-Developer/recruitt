...
::tabs
  :::tabs-item{icon="lucide:eye" label="Preview"}
    ::::accordion
      ...
      :::::accordion-item{icon="lucide:circle-help" label="What is Nuxt UI?"}
  ...
  ::accordion
    ...
    :::accordion-item{label="What is Docus and what are its key features??" icon="lucide:circle-help"}
    Docus is a fully integrated documentation solution built with Nuxt UI. It's a theme based on the UI documentation template that provides a ready-to-use visual. User can focus on content using Markdown and MDC syntax.
    :::
  
    :::accordion-item{label="How do I get started with Docus?" icon="lucide:circle-help"}
    The only thing you need to start a Docus project is a `content/` folder. You can have a check at the starter for a quick start.
    :::
  
    :::accordion-item{label="What is Nuxt UI?" icon="lucide:circle-help"}
    [Nuxt UI](https://ui.nuxt.com/) is a collection of premium Vue components, composables and utils.
    :::
  ::
  ```
...
::tabs
  :::tabs-item{.my-5 icon="lucide:eye" label="Preview"}
    ::::badge
    **v3.0.0**
    ::::
  :::
...
::tabs
  ...
  :::tabs-item{.my-5 icon="lucide:code" label="Code"}
  ```mdc
  :::card-group
